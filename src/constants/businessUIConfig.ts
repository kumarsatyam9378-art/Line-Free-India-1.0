...
export const BUSINESS_DASHBOARD_CONFIG: Record<string, BusinessDashboardConfig> = {
  ...
  unisex_salon: {
    ownerTitle: 'Unisex Salon Owner',
    businessTitle: 'My Unisex Salon',
    stats: {
      todayLabel: 'Customers Today',
      earningsLabel: "Today's Revenue",
      waitingLabel: 'In Queue',
    ...
    quickActions: [
      { icon: '✂️', label: 'Appointments', route: '/barber/customers' },
      { icon: '🖼️', label: 'Portfolio', route: '/barber/gallery' },
      { icon: '📊', label: 'Analytics', route: '/barber/analytics' },
      { icon: '👥', label: 'Staff', route: '/barber/staff' },
    ],
  ...
  spa: {
    ownerTitle: 'Spa Owner',
    businessTitle: 'My Spa',
    stats: {
      todayLabel: 'Customers Today',
      earningsLabel: "Today's Revenue",
      waitingLabel: 'In Queue',
  ...
  nail_studio: {
    ownerTitle: 'Nail Studio Owner',
    businessTitle: 'My Nail Studio',
    stats: {
      todayLabel: 'Customers Today',
      earningsLabel: "Today's Revenue",
      waitingLabel: 'In Queue',
  ...
  mehndi_artist: {
    ownerTitle: 'Mehndi Artist Owner',
    businessTitle: 'My Mehndi Artist',
    stats: {
      todayLabel: 'Customers Today',
      earningsLabel: "Today's Revenue",
      waitingLabel: 'In Queue',
  ...
  tattoo_studio: {
    ownerTitle: 'Tattoo Studio Owner',
    businessTitle: 'My Tattoo Studio',
    stats: {
      todayLabel: 'Customers Today',
      earningsLabel: "Today's Revenue",
      waitingLabel: 'In Queue',
  ...
  massage_center: {
    ownerTitle: 'Massage Center Owner',
    businessTitle: 'My Massage Center',
    stats: {
      todayLabel: 'Customers Today',
      earningsLabel: "Today's Revenue",
      waitingLabel: 'In Queue',
  ...
  acupuncture_clinic: {
    ownerTitle: 'Acupuncture Clinic Owner',
    businessTitle: 'My Acupuncture Clinic',
    stats: {
      todayLabel: 'Customers Today',
      earningsLabel: "Today's Revenue",
      waitingLabel: 'In Queue',
  ...
  makeup_artist: {
    ownerTitle: 'Makeup Artist Owner',
    businessTitle: 'My Makeup Artist',
    stats: {
      todayLabel: 'Customers Today',
      earningsLabel: "Today's Revenue",
      waitingLabel: 'In Queue',
  ...
  bridal_studio: {
    ownerTitle: 'Bridal Studio Owner',
    businessTitle: 'My Bridal Studio',
    stats: {
      todayLabel: 'Customers Today',
      earningsLabel: "Today's Revenue",
      waitingLabel: 'In Queue',
  ...
  threading_waxing_center: {
    ownerTitle: 'Threading Waxing Center Owner',
    businessTitle: 'My Threading Waxing Center',
    stats: {
      todayLabel: 'Customers Today',
      earningsLabel: "Today's Revenue",
      waitingLabel: 'In Queue',
  ...
  skin_clinic: {
    ownerTitle: 'Skin Clinic Owner',
    businessTitle: 'My Skin Clinic',
    stats: {
      todayLabel: 'Customers Today',
      earningsLabel: "Today's Revenue",
      waitingLabel: 'In Queue',
  ...
  hair_transplant_clinic: {
    ownerTitle: 'Hair Transplant Clinic Owner',
    businessTitle: 'My Hair Transplant Clinic',
    stats: {
      todayLabel: 'Customers Today',
      earningsLabel: "Today's Revenue",
      waitingLabel: 'In Queue',
  ...
  laser_hair_removal: {
    ownerTitle: 'Laser Hair Removal Owner',
    businessTitle: 'My Laser Hair Removal',
    stats: {
      todayLabel: 'Customers Today',
      earningsLabel: "Today's Revenue",
      waitingLabel: 'In Queue',
  ...
  ayurvedic_spa: {
    ownerTitle: 'Ayurvedic Spa Owner',
    businessTitle: 'My Ayurvedic Spa',
    stats: {
      todayLabel: 'Customers Today',
      earningsLabel: "Today's Revenue",
      waitingLabel: 'In Queue',
  ...
  slimming_center: {
    ownerTitle: 'Slimming Center Owner',
    businessTitle: 'My Slimming Center',
    stats: {
      todayLabel: 'Customers Today',
      earningsLabel: "Today's Revenue",
      waitingLabel: 'In Queue',
  ...
  home_salon_service: {
    ownerTitle: 'Home Salon Service Owner',
    businessTitle: 'My Home Salon Service',
    stats: {
      todayLabel: 'Customers Today',
      earningsLabel: "Today's Revenue",
      waitingLabel: 'In Queue',
