    ...
    return (
      <div className="min-h-screen flex flex-col p-6 animate-fadeIn gradient-bg-animated text-white">
        ...
        <div className="flex-1 flex flex-col items-center justify-center">
          ...
          <p className="text-xl font-bold mb-1">{user.displayName || 'Business Owner'}</p>
    ...
    <div className="min-h-screen flex flex-col gradient-bg-animated text-white relative overflow-hidden">
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-white/80 font-medium">Manage your business on Line Free</p>
        </div>
        ...
        >
          <div className="flex justify-between items-center mb-6">
            <h2 className="text-2xl font-bold">{isLogin ? 'Business Owner Login' : 'Create Business'}</h2>
            <button
