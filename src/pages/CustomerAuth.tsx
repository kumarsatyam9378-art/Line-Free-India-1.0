...
export default function CustomerAuth() {
  ...
  const handleGoogle = async () => {
    ...
    try {
      ...
      setRole('customer');
      // ✅ Check if customer already has a profile in Firestore
  ...
  return (
    <div className="min-h-screen flex flex-col p-6 animate-fadeIn">
      ...
      <div className="flex-1 flex flex-col items-center justify-center">
        <div className="w-24 h-24 rounded-3xl bg-gradient-to-br from-blue-500 to-blue-700 flex items-center justify-center mb-6 shadow-xl">
          <span className="text-5xl">👤</span>
        </div>
        <h1 className="text-2xl font-bold mb-2">{t('role.customer')}</h1>
        <p className="text-text-dim mb-10">Login to get your token & skip queues</p>
